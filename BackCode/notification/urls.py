...
from notification.views import (AdminBroadcastLogView, AdminBroadcastView,
...
urlpatterns = [
    path('recent/', NotificationRecentView.as_view(),
    ...
    path('admin/broadcast-log/', AdminBroadcastLogView.as_view(),
         name='notification-broadcast-log'),
